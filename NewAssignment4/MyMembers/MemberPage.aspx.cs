...
namespace NewAssignment4.MyMembers
{
    public partial class MemberPage : System.Web.UI.Page
    {
        ...
        private void RefreshData()
        {
            ...
            var result = from x in dbcon.Sections where x.Member_ID == Convert.ToInt32(HttpContext.Current.Session["UserID"]) select x;// need to edit this to make it the logged in memeber only.
